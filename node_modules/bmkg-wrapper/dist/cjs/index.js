...
class BMKG {
     ...
     */
    async autoGempa() {
        return await (0, index_js_1.autoGempa)();
    }
    /**
     * Mengambil list data gempa yang dirasakan.
     * @returns Array berisi data gempa yang dirasakan.
     */
    async gempaDirasakan() {
        return await (0, index_js_1.gempaDirasakan)();
    }
    /**
     ...
     */
    async gempaTerkini() {
        return await (0, index_js_1.gempaTerkini)();
    }
    /**
     ...
     */
    async prakiraanCuaca(kelurahan = 'Lebak Bulus') {
        return await (0, index_js_1.prakiraanCuaca)(kelurahan);
    }
}
exports.default = BMKG;
